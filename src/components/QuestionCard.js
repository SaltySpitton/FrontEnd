            ...
            >
                ...
                <Box 
                    ...
                    <Box 
                        ...
                        <Typography variant="h3" >{question.votes}</Typography>
                    ...
                    sx={{
                        ...
                        <Box sx={{marginTop: 1}}>
                            { question.tags && question.tags.map((tagName) => {
                                return (
                                    <Chip  
                                        variant="outlined" 
                                        size="large" 
                        ...
                        <Box sx={{
                            ...
                            {question.answers.length >= 0 && <Typography variant="h6">{question.answers.length} Answers</Typography>}
                            <UserTile 
                ...
                <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center'}}>
                    {question.answers.length > 0 &&  <Typography sx={{marginBottom: 1}}variant="h5">Answers</Typography>}   
                </Box>        
            </Box>
    </Container>
